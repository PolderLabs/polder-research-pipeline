...
| Acquisition | Protocol/search/candidate record APIs; source registration and content hashing | HTTP fetch, Git clone, arXiv retrieval, and vendor/database search clients |
