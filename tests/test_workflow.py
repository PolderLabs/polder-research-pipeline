...
class TestTasks:
    ...
    def test_acquire_lease_changes_status(self):
        from polder_research.paths import RESEARCH_TASKS_DIR
        from polder_research.tasks import acquire_lease, write_task
    ...
    def test_release_lease_returns_to_pending(self):
        from polder_research.paths import RESEARCH_TASKS_DIR
        from polder_research.tasks import acquire_lease, release_lease, write_task
    ...
    def test_update_task_status(self):
        from polder_research.paths import RESEARCH_TASKS_DIR
        from polder_research.tasks import update_task_status, write_task
...
class TestHandoffs:
    ...
    def test_reject_handoff_with_reason(self):
        from polder_research.handoffs import reject_handoff, write_handoff
        from polder_research.paths import RESEARCH_HANDOFFS_DIR
